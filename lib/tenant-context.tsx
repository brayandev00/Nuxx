...
const DEMO_TENANTS: Tenant[] = [
  {
    ...
    settings: {
      ...
      modules: ["dashboard", "projects", "team", "inventory", "finance", "payroll", "analytics", "settings", "roles"],
    },
  },
  {
    id: "tenant-002",
    ...
    settings: {
      ...
      fiscalYearStart: "01-01",
      allowCustomRoles: true,
      modules: ["dashboard", "projects", "team", "inventory", "finance", "analytics", "settings", "roles"],
    },
  },
  {
    id: "tenant-003",
    ...
    settings: {
      ...
      modules: ["dashboard", "team", "inventory", "finance", "settings"],
    },
  },
]
